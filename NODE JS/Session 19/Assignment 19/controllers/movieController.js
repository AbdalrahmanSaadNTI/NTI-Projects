...
const index = (req, res) => {
    ...
    movieModel.index(page, 20, title, cast)
        .then(({ movies, total }) => {
            const totalPages = Math.ceil(total / 20);
            res.render("pages/movies/index", { movies, page, totalPages, title, cast });
        });
}
...
const genre = (req, res) => {
    ...
    movieModel.index(page, 20, "", "", genre)
        .then(({ movies, total }) => {
            const totalPages = Math.ceil(total / 20);
            res.render("pages/movies/index", { movies, page, totalPages, title: "", cast: "", genre });
        });
}
